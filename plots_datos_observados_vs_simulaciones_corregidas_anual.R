...
valor.maximo <- round(max(estaciones.ts, eqm.ts, pqm.ts, gpqm.ts, loci.ts, ptr.ts, qdm.ts, era5.ts), 0)+1
...
png('todos_los_metodos.png', width = 720, height = 480, units = "px")
...
png('eqm.png', width = 720, height = 480, units = "px")
...
png('loci.png', width = 720, height = 480, units = "px")
...
png('pqm.png', width = 720, height = 480, units = "px")
...
png('gpqm.png', width = 720, height = 480, units = "px")
...
png('ptr.png', width = 720, height = 480, units = "px")
...
png('qdm.png', width = 720, height = 480, units = "px")
